...
SECRET_KEY = '&t7)nppw+r8^xqey#0sg60f8=l51#-x0-&foku-1el09fpxy*o'
...
# Use BCrypt hasher to store passwords, and other three hashers to check existing ones
PASSWORD_HASHERS = [
